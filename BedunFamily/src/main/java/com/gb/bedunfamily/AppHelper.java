...
public class AppHelper {
    ...
    /**
     * Set Your com.gb.bedunfamily.Model.User Pools region.
     * e.g. if your user pools are in US East (N Virginia) then set cognitoRegion = Regions.US_EAST_1.
     */

    private static final Regions cognitoRegion = Regions.US_EAST_1;

    // com.gb.bedunfamily.Model.User details from the service
    ...
    // com.gb.bedunfamily.Model.User details to display - they are the current values, including any local modification
