...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-east-1_46UNLa06g";

    /**
     * Add you app id
     */
    private static final String clientId = "65flcjg10rl870oce61gcmbdtf";
     ...
     */
    private static final String clientSecret = "145ur4bcote0vpr8qih5ldkivso3r8bmlg3t7osf77f11nv1i8gv";
    ...
    /**
     * Set Your com.gb.globalfamily.Model.User Pools region.
     * e.g. if your user pools are in US East (N Virginia) then set cognitoRegion = Regions.US_EAST_1.
     */

    private static final Regions cognitoRegion = Regions.US_EAST_1;

    // com.gb.globalfamily.Model.User details from the service
    ...
    // com.gb.globalfamily.Model.User details to display - they are the current values, including any local modification
    ...
    public static ItemToDisplay getDeviceForDisplay(int position) {
        if (position >= trustedDevices.size()) {
            return new ItemToDisplay(" ", " ", " ", Color.parseColor("#37A51C"));
        }
    ...
    public static void setDevicesForDisplay(List<CognitoDevice> devicesList) {
        ...
        for(CognitoDevice device: devicesList) {
            if (thisDevice != null && thisDevice.getDeviceKey().equals(device.getDeviceKey())) {
                ...
                ItemToDisplay item = new ItemToDisplay("", device.getDeviceName(), device.getCreateDate().toString(), Color.parseColor("#329AD6"));
