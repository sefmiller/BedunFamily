...
import static com.gb.globalfamily.SplashscreenActivity.lang;
...
public class LanguageActivity extends AppCompatActivity implements WheelPicker.OnItemSelectedListener {
    ...
    {
        SharedPreferences.Editor editor = getSharedPreferences("com.gb.globalfamily.preferences", MODE_PRIVATE).edit();
