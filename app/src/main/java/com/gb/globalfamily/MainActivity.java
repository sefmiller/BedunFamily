...
import com.gb.globalfamily.Model.Refugee;
import com.gb.globalfamily.Model.Voicemail;
import com.gb.globalfamily.Presenter.AidWorkerPresenter;
import com.gb.globalfamily.Presenter.RefugeePresenter;
...
// TODO Auto-generated method stub
     ...
     */
         ...
         */
            ...
            public void onClick(View v) {
                if (v == but) {
                    SharedPreferences.Editor editor = getContext().getSharedPreferences("com.gb.globalfamily.preferences", MODE_PRIVATE).edit();
